...
- (void)viewDidLoad
{
    ...
    [self.url appendString:[NSString stringWithFormat:@"http://thefarsinews.com/circleTweets/index.php?lat=%@&long=%@",latitude, longitude]];
    NSLog(@"url : %@",self.url);


    KMXMLParser *parser = [[KMXMLParser alloc] initWithURL:self.url delegate:self];
